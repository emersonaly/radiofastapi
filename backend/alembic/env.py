...
# This assumes we are running alembic from inside 'backend/' and the code expects 'backend' to be a top-level module
...
from backend.app.db.models import * # Import models so they are registered
